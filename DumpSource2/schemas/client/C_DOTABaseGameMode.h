...
class C_DOTABaseGameMode : public C_BaseEntity
{
	...
	C_NetworkUtlVectorBase< int32 > m_nCustomXPRequiredToReachNextLevel;
	...
	C_UtlVectorEmbeddedNetworkVar< CDOTACustomShopInfo > m_vecCustomShopInfo;
	...
	C_NetworkUtlVectorBase< AbilityID_t > m_vecAbilityUpgradeWhitelist;
